...
```{r}
sample_ids <- unique(se@meta.data$'Sample ID')
sample_ids
...
sample_seurat_object <- NormalizeData(sample_seurat_object)
sample_seurat_object <- FindVariableFeatures(sample_seurat_object)
sample_seurat_object <- ScaleData(sample_seurat_object)
sample_seurat_object <- RunPCA(sample_seurat_object)
sample_seurat_object <- FindNeighbors(sample_seurat_object)
sample_seurat_object <- FindClusters(sample_seurat_object)
Seurat::ElbowPlot(sample_seurat_object, ndims = 30)
sample_seurat_object <- RunUMAP(sample_seurat_object, dims = 1:20)
