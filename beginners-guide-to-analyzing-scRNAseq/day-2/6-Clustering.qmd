...
This notebook picks up on the cell filtering from the QC notebook and walks through the clustering steps in scRNA-seq analysis. Below, we cover essential Seurat functions as well as clustering metrics that give quantitative guidelines to how well the clustering process is performing.
...
2 - Which samples are in each cluster \# Plot sample distribution per cluster
