...
- **Library complexity**: number of genes that have expression > 0 in each cell. The more genes detected in a cell the more complex a cell is. Exampled of low complexity cells are platelets and red blood cells which can be confounded with low quality cells if not assessed properly.
...
-   We select highly variable gens following the assumption that genes that have variable expression are representative of cellular heterogeneity within our data.
