...
# save the table!
write.csv(restbl,file='./navigating-the-single-cell-landscape-a-comprehensive-workshop-on-scrnaseq/day-1/pseudobulk_analysis/results/cd4_annotation_pseudobulk_results.csv')
```
...
# save the table!
write.csv(restbl,file='./navigating-the-single-cell-landscape-a-comprehensive-workshop-on-scrnaseq/day-1/pseudobulk_analysis/results/cd8_annotation_pseudobulk_results.csv')
```
