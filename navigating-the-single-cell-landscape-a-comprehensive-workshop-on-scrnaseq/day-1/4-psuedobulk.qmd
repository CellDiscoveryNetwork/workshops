...
EnhancedVolcano(res_df,
                ...
                subtitle = 'try something different here,
...
# dir.create('./day-1/pseudobulk_analysis/figures/')
for(file in list.files('./day-1/pseudobulk_analysis/results/')){
    res_df <- read_csv(glue::glue('./day-1/pseudobulk_analysis/results/',file))
...
write_csv(
  combined_data1,
  './pseudobulk_analysis/results/combined_annot_pseudobulk_cohort_DE.csv')
write_csv(
  combined_data2,
  './pseudobulk_analysis/results/combined_clusters_pseudobulk_cohort_DE.csv')
